"""
Windows OCR pipeline aligned with Text-Grab architecture:
- structured OCR result models (line/word/bounding box)
- adaptive scaling based on detected word heights
- language-aware word joining when composing final text
"""
...
def recognize_text_from_pixmap(pixmap, language_tag="", debug_dir=None):
    ...
    final_text = _compose_text_from_result(final_result, language_tag=language_tag)
    logger.info(
