...
UI_TEXT = {
    UI_LANG_EN: {
        ...
        "settings_language_subtitle": "Select UI language (restart required to apply)",
        "settings_language_auto": "Follow System (Auto)",
        "settings_language_en": "English",
        "settings_language_zh": "简体中文",
        "language_changed_title": "Language Changed",
        "language_changed_body": "Interface language has been changed. Please restart HushSnap to fully apply the change.",
    ...
    UI_LANG_ZH: {
        ...
        "settings_language_subtitle": "选择界面语言（需重启以完全应用更改）",
        "settings_language_auto": "跟随系统 (Auto)",
        "settings_language_en": "English",
        "settings_language_zh": "简体中文",
        "language_changed_title": "语言已更改",
        "language_changed_body": "界面语言已修改，请手动重启 HushSnap 以应用更改。",
