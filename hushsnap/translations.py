...
UI_TEXT = {
    UI_LANG_EN: {
        ...
        "ocr_hotkey_taken": "OCR Screenshot {hotkey} is already in use.\nConfig: {config_path}",
        ...
        "ocr_hotkey_enabled_title": "HushSnap OCR Hotkey Enabled",
        "ocr_hotkey_enabled": "OCR screenshot {hotkey} enabled.",
        "ocr_hotkey_still_occupied": "OCR screenshot {hotkey} is still in use.",
        "ocr_hotkey_updated_title": "HushSnap OCR Hotkey Updated",
        "ocr_hotkey_updated": "OCR screenshot: {old_hotkey} -> {new_hotkey}",
        "ocr_hotkey_recover_failed": "New OCR hotkey is unavailable, and old OCR hotkey recovery failed.",
        "ocr_hotkey_kept_old": "OCR screenshot {new_hotkey} is in use. Kept {old_hotkey}.",
    },
    UI_LANG_ZH: {
        "error": "错误",
        "hotkey_taken": "{hotkey} 热键已被占用！\n配置文件: {config_path}",
        "ocr_hotkey_taken": "OCR 截图 {hotkey} 热键已被占用！\n配置文件: {config_path}",
        ...
        "ocr_hotkey_enabled_title": "HushSnap OCR 热键已启用",
        "ocr_hotkey_enabled": "OCR 截图 {hotkey} 已启用。",
        "ocr_hotkey_still_occupied": "OCR 截图 {hotkey} 仍被占用。",
        "ocr_hotkey_updated_title": "HushSnap OCR 热键已更新",
        "ocr_hotkey_updated": "OCR 截图: {old_hotkey} -> {new_hotkey}",
        "ocr_hotkey_recover_failed": "新 OCR 热键不可用，且旧 OCR 热键恢复失败。",
        "ocr_hotkey_kept_old": "OCR 截图 {new_hotkey} 被占用，已保持 {old_hotkey}。",
    },
    UI_LANG_ZH_TW: {
        "error": "錯誤",
        "hotkey_taken": "{hotkey} 熱鍵已被佔用！\n設定檔: {config_path}",
        "ocr_hotkey_taken": "OCR 截圖 {hotkey} 熱鍵已被佔用！\n設定檔: {config_path}",
        ...
        "ocr_hotkey_enabled_title": "HushSnap OCR 熱鍵已啟用",
        "ocr_hotkey_enabled": "OCR 截圖 {hotkey} 已啟用。",
        "ocr_hotkey_still_occupied": "OCR 截圖 {hotkey} 仍被佔用。",
        "ocr_hotkey_updated_title": "HushSnap OCR 熱鍵已更新",
        "ocr_hotkey_updated": "OCR 截圖: {old_hotkey} -> {new_hotkey}",
        "ocr_hotkey_recover_failed": "新 OCR 熱鍵不可用，且舊 OCR 熱鍵恢復失敗。",
        "ocr_hotkey_kept_old": "OCR 截圖 {new_hotkey} 被佔用，已保持 {old_hotkey}。",
    },
}
