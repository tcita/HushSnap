...
UI_TEXT = {
    UI_LANG_EN: {
        ...
        "editor_rotate_instruction": "Drag the handle above the image to rotate; Shift snaps to 15°, Esc cancels",
        ...
        "editor_resize_instruction": "Drag a corner to resize; Shift unlocks aspect ratio, Esc cancels",
    ...
    UI_LANG_ZH: {
        ...
        "editor_rotate_instruction": "拖动图像上方的手柄旋转；Shift 吸附 15°，Esc 取消",
        ...
        "editor_resize_instruction": "拖动角点缩放；Shift 解锁比例，Esc 取消",
    ...
    UI_LANG_ZH_TW: {
        ...
        "editor_rotate_instruction": "拖曳影像上方的手柄旋轉；Shift 吸附 15°，Esc 取消",
        ...
        "editor_resize_instruction": "拖曳角點縮放；Shift 解鎖比例，Esc 取消",
    ...
    UI_LANG_JA: {
        ...
        "editor_rotate_instruction": "画像上方のハンドルをドラッグして回転。Shift で 15° 刻み、Esc でキャンセル",
        ...
        "editor_resize_instruction": "角をドラッグしてリサイズ。Shift で縦横比の固定を解除、Esc でキャンセル",
