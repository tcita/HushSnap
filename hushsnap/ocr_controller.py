...
class OcrController:
    ...
    def on_ocr_finished(self, response, target_popup=None):
        ...
        if error:
            ...
            logging.info("[OCR_CHAIN] on_ocr_finished calling show_text (error)")
            target.show_text(
        ...
        if not recognized:
            ...
            logging.info("[OCR_CHAIN] on_ocr_finished calling show_text (empty)")
        ...
        logging.info("[OCR_CHAIN] on_ocr_finished calling show_text (result)")
        target.show_text(
            recognized,
            pixmap=pixmap,
    ...
    def start_request(self, pixmap):
        ...
        logging.info("[OCR_CHAIN] start_request")
        ...
        logging.info("[OCR_CHAIN] start_request dispatched")
